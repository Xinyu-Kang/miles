...
def load_hf_config(pretrained_model_name_or_path, **kwargs):
...
def _load_deepseek_v4_model(pretrained_model_name_or_path, **kwargs):
    try:
        from sglang.srt.utils.hf_transformers.common import _load_deepseek_v4_model as load_config

        return load_config(pretrained_model_name_or_path, **kwargs)
    except ImportError:
